...
void Image::UpdateGLTexture()
{
    ...
    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, m_internalResWidth, m_internalResHeight, GL_RED, GL_UNSIGNED_BYTE,
                    m_imageBuffer.data());
...
bool Image::InitializeImage()
{
    ...
    glBindTexture(GL_TEXTURE_2D, m_texture);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RED, m_internalResWidth, m_internalResHeight, 0, GL_RED, GL_UNSIGNED_BYTE,
                 (void*)0);
