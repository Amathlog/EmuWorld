...
using GBEmulatorExe::Shader;

Shader::Shader(const char* vertexPrg, const char* fragmentPrg) { CreateShaders(vertexPrg, fragmentPrg); }
...
void Shader::UseProgram() { glUseProgram(m_programId); }