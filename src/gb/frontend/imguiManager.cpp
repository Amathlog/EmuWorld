...
#include <frontend/imguiWindows/debugWindow.h>
#include <frontend/imguiWindows/findRomsWindow.h>
#include <frontend/imguiWindows/imguiWindow.h>
#include <frontend/imguiWindows/oamWindow.h>
#include <frontend/imguiWindows/ramWindow.h>
...
std::string ImguiCachePath() { return (Common::Utils::GetExePath() / "imgui.cache").string(); }

void ImguiManager::Serialize()
{
    Common::Utils::FileWriteVisitor visitor(ImguiCachePath(), true);
...
{
    Common::Utils::FileReadVisitor visitor(ImguiCachePath(), true);
