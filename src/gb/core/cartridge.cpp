...
Cartridge::Cartridge(Common::Utils::IReadVisitor& visitor)
{
...
void Cartridge::SerializeRam(Common::Utils::IWriteVisitor& visitor) const { visitor.WriteContainer(m_externalRAM); }
...
void Cartridge::DeserializeRam(Common::Utils::IReadVisitor& visitor) { visitor.ReadContainer(m_externalRAM); }
