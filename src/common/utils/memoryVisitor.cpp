...
using Common::Utils::MemoryReadVisitor;
using Common::Utils::MemoryWriteVisitor;
...
size_t MemoryReadVisitor::Remaining() const { return m_size - m_ptr; }
...
size_t MemoryWriteVisitor::Written() const { return m_ptr; }