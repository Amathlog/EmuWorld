...
public:
    ...
    void SerializeTo(Common::Utils::IWriteVisitor& visitor) const override { visitor.WriteValue(m_buttons.reg); }

    void DeserializeFrom(Common::Utils::IReadVisitor& visitor) override { visitor.ReadValue(m_buttons.reg); }
