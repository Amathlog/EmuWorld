...
public:
    ...
    void SaveCartridgeRAM(Common::Utils::IWriteVisitor& visitor) const { m_cartridge->SerializeRam(visitor); }
    void LoadCartridgeRAM(Common::Utils::IReadVisitor& visitor) { m_cartridge->DeserializeRam(visitor); }
