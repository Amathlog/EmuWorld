...
{
    StepMessage()
        : DebugMessage(DefaultDebugMessageType::STEP, nullptr, 0, 0, 0, 0)
    {
    }
};
...
struct BreakContinueMessage : DebugMessage
{
    BreakContinueMessage()
        : DebugMessage(DefaultDebugMessageType::BREAK_CONTINUE, nullptr, 0, 0, 0, 0)
    {
    }
};
...
struct GetBreakStatusMessage : DebugMessage
{
    GetBreakStatusMessage()
        : DebugMessage(DefaultDebugMessageType::GET_BREAK_STATUS, nullptr, 0, 0, 0, 0)
    {
    }
};
...
{
    GetCPURegistersInfoMessage()
        : DebugMessage(DefaultDebugMessageType::GET_CPU_REGISTERS, nullptr, 0, 0, 0, 0)
    {
    }
};
...
{
    RunToMessage(uint16_t address)
        : DebugMessage(DefaultDebugMessageType::RUN_TO, nullptr, 0, 0, address, 0)
    {
    }
};
...
{
    SetBreakOnStartMessage(bool value)
        : DebugMessage(DefaultDebugMessageType::SET_BREAK_ON_START, value)
    {
    }
};
