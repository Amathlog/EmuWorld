...
static constexpr const char* ROOT_FILE = "emuworld_root.myroot";
...
#else
inline std::filesystem::path GetExePath() { return std::filesystem::canonical("/proc/self/exe").parent_path(); }
#endif
